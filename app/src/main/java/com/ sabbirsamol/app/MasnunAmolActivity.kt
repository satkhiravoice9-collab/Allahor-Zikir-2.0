...
class MasnunAmolActivity : ComponentActivity() {
    ...
    private val folder3 = DoaFolder(
        ...
        doasList = listOf(
            ...
            DoaItem("২৯। তওবা ও ক্ষমা প্রার্থনা", "رَبِّ اغْفِرْ لِي وَتُبْ عَلَيَّ إِنَّكَ أَنْتَ التَّوَّابُ الرَّحِيمُ", "রাব্বিগফির লী ওয়া তুব আলাইয়া, ইন্নাকা আন্তাত তাওয়াবুর রাহীম।", "হে আমাদের রব! আমাদের ক্ষমা করুন এবং আমাদের তওবা কবুল করুন। নিশ্চয়ই আপনি তওবা কবুলকারী, পরম দয়ালু।"),
