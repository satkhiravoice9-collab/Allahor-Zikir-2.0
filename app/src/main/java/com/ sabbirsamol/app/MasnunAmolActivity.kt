...
class MasnunAmolActivity : ComponentActivity() {
    ...
    private val ayatusSeherPdf = AmolPdfItem("ayatus_seher.pdf", "আয়াতুস সেহের", "1G5Bl4fq-4woUFNJrPFhTBB-q0O2JROES", "জাদু ও কুফরি প্রভাব থেকে বাঁচার বিশেষ আয়াতসমূহ।")
    private val ayateKutubPdf = AmolPdfItem("ayate_kutub.pdf", "আয়াতে কুতুব", "14d7e_rjDOLVIiNc9GDvnGEUIrOLCyWq_", "নিরাপত্তা ও হেফাজতের জন্য পরীক্ষিত আয়াতে কুতুব সংকলন।")
    private val surahYasinMubinPdf = AmolPdfItem("surah_yasin_mubin.pdf", "সুরা ইয়াসিন মুবিন বাই মুবিন", "10Vexi7BWNHHaNlnE-hxM6Xbik4sxPMQs", "মুবিন মুবিন বিশিষ্ট বরকতময় সুরা ইয়াসিন শরীফ।")
    ...
    private val folder3 = DoaFolder(
        ...
        doasList = listOf(
            ...
            DoaItem("২৯। তওবা ও ক্ষমা প্রার্থনা", "رَبِّ اغْفِرْ لِي وَتُبْ عَلَيَّ إِنَّكَ أَنْتَ التَّوَّابُ الرَّحِيمُ", "রাব্বিগفیر লী ওয়া তুব আলাইয়া, ইন্নাকা আন্তাত তাওয়াবুর রাহীম।", "হে আমাদের রব! আমাদের ক্ষমা করুন এবং আমাদের তওবা কবুল করুন। নিশ্চয়ই আপনি তওবা কবুলকারী, পরম দয়ালু।"),
    ...
    private val folder4 = DoaFolder(
        id = 4, title = "📁 ফোল্ডার ৬: নামাজের দোয়া, যিকির ও জানাজা",
        ...
        doasList = listOf(
            ...
            DoaItem("৬। দুই সিজদার মাঝখানের দোয়া", "رَبِّ اغْفِرْ لِي", "রাব্বিগফির লী।", "হে আমাদের রব! আমাদের ক্ষমা করুন।"),
    ...
    private fun showMainFolders() {
        ...
        content.addView(createAmolPdfCard(ayateKutubPdf))
        content.addView(createAmolPdfCard(surahYasinMubinPdf))
    ...
    private fun createAmolPdfCard(item: AmolPdfItem): View {
        ...
        val folderTitle = when {
            item.fileName.contains("masnun") -> "📁 ফোল্ডার ১: মাসনূন আমল"
            item.fileName.contains("manzil") -> "📁 ফোল্ডার ২: মানযিল আয়াত (সম্পূর্ণ)"
            item.fileName.contains("ayatus_seher") -> "📁 ফোল্ডার ৩: আয়াতুস সেহের"
            item.fileName.contains("ayate_kutub") -> "📁 ফোল্ডার ৪: আয়াতে কুতুব"
            else -> "📁 ফোল্ডার ৫: সুরা ইয়াসিন মুবিন বাই মুবিন"
        }
