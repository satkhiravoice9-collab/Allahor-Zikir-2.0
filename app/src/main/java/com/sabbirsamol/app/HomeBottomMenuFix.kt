...
/**
 * Keeps the existing Home Screen logic intact and converts its seven bottom
 * menu buttons into a compact horizontal bottom navigation bar.
 */
    ...
    private fun fixBottomMenu(activity: Activity) {
        ...
        for (i in 0 until menu.childCount) {
            ...
            if (child is Button) {
                ...
                child.layoutParams = LinearLayout.LayoutParams(0, -1, 1f).apply {
                    setMargins(1, 0, 1, 0)
                }
            }
        }
