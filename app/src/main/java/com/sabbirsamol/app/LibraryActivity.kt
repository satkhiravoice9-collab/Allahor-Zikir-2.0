...
class LibraryActivity : ComponentActivity() {
    ...
    private val surahList = listOf(
        ...
        Pair("৬৫. সূরা আত-ত্বালাক (পৃষ্ঠা ৫৪৯)", 559),
        Pair("৬৬. সূরা আত-তাহরীম (পৃষ্ঠা ৫৬১)", 561),
        ...
        Pair("৭২. সূরা আল-জ্বিন (পৃষ্ঠা ৫৭১৪)", 574),
        Pair("৭৩. সূরা আল-মুযযাম্মিল (পৃষ্ঠা ৫৭৭)", 577),
        Pair("৭৪. সূরা আল-মুদ্দাসসির (পৃষ্ঠা ৫ ১৯৭)", 579),
        Pair("৭৫. সূরা আল-কিয়ামাহ (পৃষ্ঠা ৫৮১)", 581),
        Pair("৭৬. সূরা আদ-দাহর / আল-ইনসান (পৃষ্ঠা ৫ ১৯৮)", 583),
        Pair("৭৭. সূরা আল-মুরসালাত (পৃষ্ঠা ৫৮৫)", 585),
        Pair("৭৮. সূরা আন-নাবা (পৃষ্ঠা ৫৮৭)", 587),
        Pair("৭৯. সূরা আন-নযিয়াত (পৃষ্ঠা ৫ ১৯৮)", 588),
        Pair("৮০. সূরা আবাসা (পৃষ্ঠা ৫৯০)", 590),
        Pair("৮১. সূরা আত-তাকভীর (পৃষ্ঠা ৫৯১)", 591),
        Pair("৮২. সূরা আল-ইনফিতার (পৃষ্ঠা ৫৯২)", 592),
        Pair("৮৩. সূরা আল-মুতাফফিফিন (পৃষ্ঠা ৫৯৩)", 593),
        Pair("৮৪. সূরা আল-ইনশিকাক (পৃষ্ঠা ৫৯৫)", 595),
        Pair("৮৫. সূরা আল-বুরূজ (পৃষ্ঠা ৫৯৬)", 596),
        Pair("৮৬. সূরা আত-তারিক (পৃষ্ঠা ৫৯৭)", 597),
        Pair("৮৭. সূরা আল-আ'লা (পৃষ্ঠা ৫৯৮)", 598),
        Pair("৮৮. সূরা আল-গাশিয়াহ (পৃষ্ঠা ৫৯৯)", 599),
        ...
        Pair("৯৮. সূরা আল-বাইয়্যিনাহ (পৃষ্ঠা ৬০৬)", 606),
        Pair("৯৯. সূরা আয-যিলযাল (পৃষ্ঠা ৬০৬)", 606),
        Pair("১০০. সূরা আল-আদিয়াত (পৃষ্ঠা ৬০৭)", 607),
        Pair("১০১. সূরা আল-কারিয়াহ (পৃষ্ঠা ৬০৭)", 607),
        ...
        Pair("১০৮. সূরা আল-কাওসার (পৃষ্ঠা ৬০৯)", 609),
        ...
        Pair("১১৪. সূরা আন-নাস (পৃষ্ঠা ৬১১)", 611)
    )
