...
class LibraryActivity : ComponentActivity() {
    ...
    private val paraList = listOf(
        ...
        Pair("পারা ১২: ওয়া মা মিন দা-ব্বাহ (وَمَا مِنْ دَابَّةٍ) (পৃষ্ঠা ২২৩)", 223),
        Pair("পারা ১৩: ওয়া মা উবাররিউ (وَمَا أُبَرِّئُ) (পৃষ্ঠা ২৪৪)", 244),
        Pair("পারা ১৪: রুবামা (رُبَمَا) (পৃষ্ঠা ২৬৩)", 263),
        Pair("পারা ১৫: সুবহানাল্লাযী (سُبْحَانَ الَّذِي) (পৃষ্ঠা ২৮৪)", 284),
        Pair("পারা ১৬: ক্বালা আলাম (قَالَ أَلَمْ) (পৃষ্ঠা ৩০৪)", 304),
        Pair("পারা ১৭: ইক্বতারা বা লিন্নাস (اقْتَرَبَ لِلنَّاسِ) (পৃষ্ঠা ৩২৪)", 324),
        Pair("পারা ১৮: ক্বাদ আফলাহা (قَدْ أَفْلَحَ) (পৃষ্ঠা ৩৪৪)", 344),
        Pair("পারা ১৯: ওয়া ক্বাল্লাযীনা (وَقَالَ الَّذِينَ) (পৃষ্ঠা ৩৬৪)", 364),
        Pair("পারা ২০: আম্মান খালাক্বা (أَمَّنْ خَلَقَ) (পৃষ্ঠা ৩৮৪)", 384),
        Pair("পারা ২১: উতলু মা উহিয়া (اتْلُ مَا أُوحِيَ) (পৃষ্ঠা ৪০৪)", 404),
        Pair("পারা ২২: ওয়া মাই-য়াক্বনুত (وَمَنْ يَقْنُتْ) (পৃষ্ঠা ৪২৪)", 424),
        Pair("পারা ২৩: ওয়া মালি-য়া (وَمَا لِيَ) (পৃষ্ঠা ৪৪৪)", 444),
        Pair("পারা ২৪: ফামান আজলামু (فَمَنْ أَظْلَمُ) (পৃষ্ঠা ৪৬৪)", 464),
        Pair("পারা ২৫: ইলাইহি ইউরাদ্দু (إِلَيْهِ يُرَدُّ) (পৃষ্ঠা ৪৮৪)", 484),
        Pair("পারা ২৬: হা-মীম (حم) (পৃষ্ঠা ৫০৪)", 504),
        Pair("পারা ২৭: ক্বালা ফামা খাতবুকুম (قَالَ فَمَا خَطْبُكُمْ) (পৃষ্ঠা ৫২৪)", 524),
        Pair("পারা ২৮: ক্বাদ সামিআল্লাহ (قَدْ سَمِعَ اللَّهُ) (পৃষ্ঠা ৫৪৪)", 544),
        Pair("পারা ২৯: তাবারাকাল্লাযী (تَبَارَكَ الَّذِي) (পৃষ্ঠা ৫৬৪)", 564),
        Pair("পারা ৩০: আম্মা ইয়াতাসায়ালুন (عَمَّ يَتَسَاءَلُونَ) (পৃষ্ঠা ৫৮৮)", 588)
    )

    private val surahList = listOf(
        Pair("১. সূরা আল-ফাতিহা (পৃষ্ঠা ২)", 2),
        Pair("২. সূরা আল-বাকারা (পৃষ্ঠা ৪)", 4),
        Pair("৩. সূরা আলে ইমরান (পৃষ্ঠা ৫২)", 52),
        Pair("৪. সূরা আন-নিসা (পৃষ্ঠা ৭৯)", 79),
        Pair("৫. সূরা আল-মায়িদাহ (পৃষ্ঠা ১০৮)", 108),
        Pair("৬. সূরা আল-আনআম (পৃষ্ঠা ১৩০)", 130),
        Pair("৭. সূরা আল-আরাফ (পৃষ্ঠা ১৫৩)", 153),
        Pair("৮. সূরা আল-আনফাল (পৃষ্ঠা ১৭৯)", 179),
        Pair("৯. সূরা আত-তাওবাহ (পৃষ্ঠা ১৮৯)", 189),
        Pair("১০. সূরা ইউনুস (পৃষ্ঠা ২১০)", 210),
        Pair("১১. সূরা হূদ (পৃষ্ঠা ২২৩)", 223),
        Pair("১২. সূরা ইউসুফ (পৃষ্ঠা ২৩৭)", 237),
        Pair("১৩. সূরা আর-রাদ (পৃষ্ঠা ২৫১)", 251),
        Pair("১৪. সূরা ইবরাহিম (পৃষ্ঠা ২৫৭)", 257),
        Pair("১৫. সূরা আল-হিজর (পৃষ্ঠা ২৬৩)", 263),
        Pair("১৬. সূরা আন-নাহল (পৃষ্ঠা ২৬৯)", 269),
        Pair("১৭. সূরা আল-ইসরা (বনী ইসরাইল) (পৃষ্ঠা ২৮৪)", 284),
        Pair("১৮. সূরা আল-কাহফ (পৃষ্ঠা ২৯৫)", 295),
        Pair("১৯. সূরা মারইয়াম (পৃষ্ঠা ৩০৭)", 307),
        Pair("২০. সূরা ত্ব-হা (পৃষ্ঠা ৩১৪)", 314),
        Pair("২১. সূরা আল-আম্বিয়া (পৃষ্ঠা ৩২৪)", 324),
        Pair("২২. সূরা আল-হাজ্জ (পৃষ্ঠা ৩৩৩)", 333),
        Pair("২৩. সূরা আল-মুমিনুন (পৃষ্ঠা ৩৪৪)", 344),
        Pair("২৪. সূরা আন-নূর (পৃষ্ঠা ৩৫২)", 352),
        Pair("২৫. সূরা আল-ফুরকান (পৃষ্ঠা ৩৬১)", 361),
        Pair("২৬. সূরা আশ-শুআরা (পৃষ্ঠা ৩৬৮)", 368),
        Pair("২৭. সূরা আন-নামল (পৃষ্ঠা ৩৭৮)", 378),
        Pair("২৮. সূরা আল-কাসাস (পৃষ্ঠা ৩৮৭)", 387),
        Pair("২৯. সূরা আল-আনকাবুত (পৃষ্ঠা ৩৯৮)", 398),
        Pair("৩০. সূরা আর-রূম (পৃষ্ঠা ৪০৬)", 406),
        Pair("৩১. সূরা লুকমান (পৃষ্ঠা ৪১৩)", 413),
        Pair("৩২. সূরা আস-সাজদাহ (পৃষ্ঠা ৪১৭)", 417),
        Pair("৩৩. সূরা আল-আহযাব (পৃষ্ঠা ৪২০)", 420),
        Pair("৩৪. সূরা সাবা (পৃষ্ঠা ৪৩০)", 430),
        Pair("৩৫. সূরা ফাতির (পৃষ্ঠা ৪৩৬)", 436),
        Pair("৩৬. সূরা ইয়াসিন (পৃষ্ঠা ৪৪২)", 442),
        Pair("৩৭. সূরা আস-সাফফাত (পৃষ্ঠা ৪৪৭)", 447),
        Pair("৩৮. সূরা সোয়াদ (পৃষ্ঠা ৪৫৪)", 454),
        Pair("৩৯. সূরা আয-যুমার (পৃষ্ঠা ৪৬০)", 460),
        Pair("৪০. সূরা গাফিল / আল-মুমিন (পৃষ্ঠা ৪৬৯)", 469),
        Pair("৪১. সূরা ফুসসিলাত (পৃষ্ঠা ৪৭৯)", 479),
        Pair("৪২. সূরা আশ-শূরা (পৃষ্ঠা ৪৮৫)", 485),
        Pair("৪৩. সূরা আয-যুখরুফ (পৃষ্ঠা ৪৯১)", 491),
        Pair("৪৪. সূরা আদ-দুখান (পৃষ্ঠা ৪৯৭)", 497),
        Pair("৪৫. সূরা আল-জাসিয়াহ (পৃষ্ঠা ৫০০)", 500),
        Pair("৪৬. সূরা আল-আহকাফ (পৃষ্ঠা ৫০৪)", 504),
        Pair("৪৭. সূরা মুহাম্মদ (পৃষ্ঠা ৫০৮)", 508),
        Pair("৪৮. সূরা আল-ফাতহ (পৃষ্ঠা ৫১৩)", 513),
        Pair("৪৯. সূরা আল-হুজুরাত (পৃষ্ঠা ৫১৭)", 517),
        Pair("৫০. সূরা কাফ (পৃষ্ঠা ৫২০)", 520),
        Pair("৫১. সূরা আয-যারিয়াত (পৃষ্ঠা ৫২২)", 522),
        Pair("৫২. সূরা আত-তূর (পৃষ্ঠা ৫২৫)", 525),
        Pair("৫৩. সূরা আন-নাজম (পৃষ্ঠা ৫২৮)", 528),
        Pair("৫৪. সূরা আল-কামার (পৃষ্ঠা ৫৩০)", 530),
        Pair("৫৫. সূরা আর-রহমান (পৃষ্ঠা ৫৩৩)", 533),
        Pair("৫৬. সূরা আল-ওয়াকিয়াহ (পৃষ্ঠা ৫৩৬)", 536),
        Pair("৫৭. সূরা আল-হাদিদ (পৃষ্ঠা ৫৩৯)", 539),
        Pair("৫৮. সূরা আল-মুজাদালাহ (পৃষ্ঠা ৫৪৪)", 544),
        Pair("৫৯. সূরা আল-হাশর (পৃষ্ঠা ৫৪৭)", 547),
        Pair("৬০. সূরা আল-মুমতাহিনাহ (পৃষ্ঠা ৫৫১)", 551),
        Pair("৬১. সূরা আস-সাফ (পৃষ্ঠা ৫৫৩)", 553),
        Pair("৬২. সূরা আল-জুমুআহ (পৃষ্ঠা ৫৫৫)", 555),
        Pair("৬৩. সূরা আল-মুনাফিকুন (পৃষ্ঠা ৫৫৬)", 556),
        Pair("৬৪. সূরা আত-তাগাবুন (পৃষ্ঠা ৫৫৮)", 558),
        Pair("৬৫. সূরা আত-তালাক (পৃষ্ঠা ৫৬০)", 560),
        Pair("৬৬. সূরা আত-তাহরিম (পৃষ্ঠা ৫৬২)", 562),
        Pair("৬৭. সূরা আল-মুলক (পৃষ্ঠা ৫৬৪)", 564),
        Pair("৬৮. সূরা আল-কলম (পৃষ্ঠা ৫৬৬)", 566),
        Pair("৬৯. সূরা আল-হাক্কাহ (পৃষ্ঠা ৫৬৯)", 569),
        Pair("৭০. সূরা আল-মাআরিজ (পৃষ্ঠা ৫৭১)", 571),
        Pair("৭১. সূরা নূহ (পৃষ্ঠা ৫ ইত্যাদি)", 573),
        Pair("৭২. সূরা আল-জিন (পৃষ্ঠা ৫ ইত্যাদি)", 575),
        Pair("৭৩. সূরা আল-মুযযাম্মিল (পৃষ্ঠা ৫৭৮)", 578),
        Pair("৭৪. সূরা আল-মুদ্দাসসির (পৃষ্ঠা ৫৮০)", 580),
        Pair("৭৫. সূরা আল-কিয়ামাহ (পৃষ্ঠা ৫৮২)", 582),
        Pair("৭৬. সূরা আল-ইনসান / আদ-দাহর (পৃষ্ঠা ৫৮৪)", 584),
        Pair("৭৭. সূরা আল-মুরসালাত (পৃষ্ঠা ৫৮৬)", 586),
        Pair("৭৮. সূরা আন-নাবা (পৃষ্ঠা ৫৮৮)", 588),
        Pair("৭৯. সূরা আন-নাযিআত (পৃষ্ঠা ৫৮৯)", 589),
        Pair("৮০. সূরা আবাসা (পৃষ্ঠা ৫৯১)", 591),
        Pair("৮১. সূরা আত-তাকভির (পৃষ্ঠা ৫৯২)", 592),
        Pair("৮২. সূরা আল-ইনফিতার (পৃষ্ঠা ৫৯৩)", 593),
        Pair("৮৩. সূরা আল-মুতাফফিফিন (পৃষ্ঠা ৫৯৪)", 594),
        Pair("৮৪. সূরা আল-ইনশিকাক (পৃষ্ঠা ৫৯৬)", 596),
        Pair("৮৫. সূরা আল-বুরুজ (পৃষ্ঠা ৫৯৭)", 597),
        Pair("৮৬. সূরা আত-তারিক (পৃষ্ঠা ৫৯৮)", 598),
        Pair("৮৭. সূরা আল-আলা (পৃষ্ঠা ৫৯৯)", 599),
        Pair("৮৮. সূরা আল-গাশিয়াহ (পৃষ্ঠা ৬০০)", 600),
        Pair("৮৯. সূরা আল-ফজর (পৃষ্ঠা ৬০১)", 601),
        Pair("৯০. সূরা আল-বালাদ (পৃষ্ঠা ৬০২)", 602),
        Pair("৯১. সূরা আশ-শামস (পৃষ্ঠা ৬০৩)", 603),
        Pair("৯২. সূরা আল-লাইল (পৃষ্ঠা ৬০৪)", 604),
        Pair("৯৩. সূরা আদ-দুহা (পৃষ্ঠা ৬০৪)", 604),
        Pair("৯৪. সূরা আশ-শারহ (পৃষ্ঠা ৬০৪)", 604),
        Pair("৯৫. সূরা আত-তিন (পৃষ্ঠা ৬০৫)", 605),
        Pair("৯৬. সূরা আল-আলাক (পৃষ্ঠা ৬০৬)", 606),
        Pair("৯৭. সূরা আল-কদর (পৃষ্ঠা ৬০৬)", 606),
        Pair("৯৮. সূরা আল-বাইয়্যিনাহ (পৃষ্ঠা ৬০৭)", 607),
        Pair("৯৯. সূরা আয-যিলযাল (পৃষ্ঠা ৬০৭)", 607),
        Pair("১০০. সূরা আল-আদিয়াত (পৃষ্ঠা ৬০৮)", 608),
        Pair("১০১. সূরা আল-কারিয়াহ (পৃষ্ঠা ৬০৮)", 608),
        Pair("১০২. সূরা আত-তাকাসুর (পৃষ্ঠা ৬০৮)", 608),
        Pair("১০৩. সূরা আল-আসর (পৃষ্ঠা ৬০৯)", 609),
        Pair("১০৪. সূরা আল-হুমাযাহ (পৃষ্ঠা ৬০৯)", 609),
        Pair("১০৫. সূরা আল-ফিল (পৃষ্ঠা ৬০৯)", 609),
        Pair("১০৬. সূরা কুরাইশ (পৃষ্ঠা ৬১০)", 610),
        Pair("১০৭. সূরা আল-মাউন (পৃষ্ঠা ৬১০)", 610),
        Pair("১০৮. সূরা আল-কাওসার (পৃষ্ঠা ৬১০)", 610),
        Pair("১০৯. সূরা আল-কাফিরুন (পৃষ্ঠা ৬১১)", 611),
        Pair("১১০. সূরা আন-নাসর (পৃষ্ঠা ৬১১)", 611),
        Pair("১১১. সূরা আল-মাসাদ / লাহাব (পৃষ্ঠা ৬১১)", 611),
        Pair("১১২. সূরা আল-ইখলাস (পৃষ্ঠা ৬১১)", 611),
        Pair("১১৩. সূরা আল-ফালাক (পৃষ্ঠা ৬১২)", 612),
        Pair("১১৪. সূরা আন-নাস (পৃষ্ঠা ৬১২)", 612)
    )
