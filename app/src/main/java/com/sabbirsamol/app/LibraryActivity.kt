...
class LibraryActivity : ComponentActivity() {
    ...
    private val paraList = listOf(
        ...
        Pair("পারা ২৭: ক্বালা ফামা খাতবুকুম (قَالَ فَمَا خَطْبُكُمْ) (পৃষ্ঠা ৫২৪)", 524), Pair("পারা ২৮: ক্বাদ সামিআল্লাহ (পাদ সামী আল্লাহ) (পৃষ্ঠা ৫৪৪)", 544),
    ...
    private val surahList = listOf(
        ...
        Pair("৬৭. সূরা আল-মুলক (পৃষ্ঠা ৫৬۶)", 566), Pair("৬৮. সূরা আল-কলম (পৃষ্ঠা ৫৬৮)", 568),
        ...
        Pair("৭৭. সূরা আল-মুরসালাত (পৃষ্ঠা ৫৮০)", 580), Pair("৭৮. সূরা আন-নাবা (পৃষ্ঠা ৫৬৬)", 586),
        Pair("৭৯. সূরা আন-নযিয়াত (পৃষ্ঠা ৫৬৮)", 588), Pair("৮০. সূরা আবাসা (পৃষ্ঠা ৫৭০)", 590),
        Pair("৮১. সূরা আত-তাকভীর (পৃষ্ঠা ৫৭১)", 591), Pair("৮২. সূরা আল-ইনফিতার (পৃষ্ঠা ৫৯২)", 592),
