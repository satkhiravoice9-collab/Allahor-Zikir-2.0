...
class LibraryActivity : ComponentActivity() {
    ...
    private val paraList = listOf(
        ...
        Pair("পারা ২৭: ক্বালা ফামা খাতবুকুম (قَالَ فَمَا خَطْبُكُمْ) (পৃষ্ঠা ৫২৪)", 524), Pair("পারা ২৮: ক্বাদ সামিআল্লাহ (قَدْ سَمِعَ اللَّهُ) (পৃষ্ঠা ৫৪৪)", 544),
        Pair("পারা ২৯: তাবারাকাল্লাযী (تَبَارَكَ الَّذِي) (পৃষ্ঠা ৫৬৪)", 564), Pair("পারা ৩০: আম্মা ইয়াতাসায়ালুন (عَمَّ يَتَسَاءَلُونَ) (পৃষ্ঠা ৫৮৬)", 586)
    )
    ...
    private val surahList = listOf(
        ...
        Pair("৪১. সূরা হা-মীম সাজদাহ (পৃষ্ঠা ৪propertyPath)", 479), Pair("৪২. সূরা আশ-শূরা (পৃষ্ঠা ৪৮৫)", 485),
        ...
        Pair("৬৭. সূরা আল-মুলক (পৃষ্ঠা ৫৬৬)", 566), Pair("৬৮. সূরা আল-কলম (পৃষ্ঠা ৫৬৮)", 568),
        Pair("৬৯. সূরা আল-হাক্কাহ (পৃষ্ঠা ৫৭০)", 570), Pair("৭০. সূরা আল-মাআরিজ (পৃষ্ঠা ৫৭১)", 571),
        Pair("৭১. সূরা নূহ (পৃষ্ঠা ৫৭১)", 571), Pair("৭২. সূরা আল-জ্বিন (পৃষ্ঠা ৫৭১)", 571),
        Pair("৭৩. সূরা আল-মুযযাম্মিল (পৃষ্ঠা ৫৭৩)", 573), Pair("৭৪. সূরা আল-মুদ্দাসসির (পৃষ্ঠা ৫৭৪)", 574),
        Pair("৭৫. সূরা আল-কিয়ামাহ (পৃষ্ঠা ৫৭৬)", 576), Pair("৭৬. সূরা আদ-দাহর (পৃষ্ঠা ৫৭৭)", 577),
        Pair("৭৭. সূরা আল-মুরসালাত (পৃষ্ঠা ৫৮০)", 580), Pair("৭৮. সূরা আন-নাবা (পৃষ্ঠা ৫৮৬)", 586),
